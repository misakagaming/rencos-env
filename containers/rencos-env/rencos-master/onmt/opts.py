...
def preprocess_opts(parser):
    ...
    group.add('--src_vocab_size', '-src_vocab_size', type=int, default=50495,
              help="Size of the source vocabulary")
    group.add('--ref_vocab_size', '-ref_vocab_size', type=int, default=50495,
              help="Size of the reference vocabulary")
    group.add('--tgt_vocab_size', '-tgt_vocab_size', type=int, default=50495,
...
def translate_opts(parser):
    ...
    group.add('--search', '-search', type=int, default=0,
              help="Run in  search mode.")
    group.add('--refer', '-refer', type=int, default=0,
              help="Use refer")
    group.add('--guide', '-guide', type=int, default=0)
